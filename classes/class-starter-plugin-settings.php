...
/**
 * Kingdom_Training_Settings Class
 *
 * @class Kingdom_Training_Settings
 * @version	1.0.0
 * @since 1.0.0
 * @package	Kingdom_Training
 * @author Jeffikus
 */
final class Kingdom_Training_Settings {
	/**
	...
	/**
	 * Main Kingdom_Training_Settings Instance
	 *
	 * Ensures only one instance of Kingdom_Training_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @return Main Kingdom_Training_Settings instance
	 */
	...
	public function render_field ( $args ) {
		...
		// Construct the key.
		$key 				= Kingdom_Training()->token . '-' . $args['section'] . '[' . $args['id'] . ']';
